  ...
  return (
    <>
      <div className="fixed top-0 left-0 w-full flex justify-center items-center">
        <div className="fixed inset-0 flex items-center justify-center z-50 bg-gray-500 bg-opacity-70">
          <div className="text-center sm:p-5 border-slate-700 border rounded-xl bg-white scale-up-center">
